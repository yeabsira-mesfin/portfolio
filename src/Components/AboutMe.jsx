  ...
  return (
    <section id="about" className="py-16 px-8 bg-gray-50">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-lg text-[#243d27] leading-relaxed mt-4">
          Let’s connect on <a href="https://www.linkedin.com/in/yeabsira-mesfin-76379928a" target="_blank" rel="noopener noreferrer" className="text-[#2a9d8f] underline">LinkedIn</a> or <a href="https://github.com/yeabsira-mesfin" target="_blank" rel="noopener noreferrer" className="text-[#2a9d8f] underline">GitHub</a>—whether to chat, collaborate, or maybe even work together. Who knows? I could be the person you’ve been looking for!
        </p>
      </div>
